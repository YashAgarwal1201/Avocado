<template>
  ...
  >
    <RouterLink
        class="w-auto md:w-full h-full md:h-auto p-button aspect-square flex justify-center items-center !border-none !rounded-2xl !bg-yellow-600 dark:!bg-yellow-500 hover:!bg-yellow-700 dark:hover:!bg-yellow-400"
        to="/"
    >
      <Home :size="16"/>
    </RouterLink>
